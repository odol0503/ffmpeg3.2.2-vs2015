...
#define FFMPEG_CONFIGURATION "--enable-ffplay --enable-ffprobe --enable-ffserver --enable-librtmp --disable-optimizations --disable-stripping --disable-memalign-hack --disable-mmx --disable-ssse3 --enable-debug=3 extra-cflags='-O0 -fno-inline' --enable-gpl --extra-ldflags=-L/local/lib"
